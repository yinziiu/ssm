...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-service-update" action="" method="post" class="form form-horizontal" >
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelService1.id }" id="id" name="id">
					</div>
				</div>
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelService1.hid }" id="hid" name="hid">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店服务名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelService1.name }" placeholder="请输入酒店服务" id="name" name="name">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			function save(){
	       		var formData = new FormData($("#hotel-service-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update_HotelService" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
