...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-info-add" action="" method="post" class="form form-horizontal">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hid }" id="hid" name="hid" readonly="readonly" style="width: 70%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店入住时间" id="checkintime" name="checkintime" style="width: 70%">点之后
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店离店时间" id="checkouttime" name="checkouttime" style="width: 70%">点之后
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店建成于几年" id="activate" name="activate" style="width: 70%">年
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店规模" id="scale" name="scale" style="width: 70%">间客房
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#hotel-info-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/savaHotelInfo" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
