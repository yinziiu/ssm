...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>酒店管理 <span class="c-gray en">&gt;</span> 酒店设备列表
...
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" name="" id="" placeholder=" 酒店设备名称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i>搜酒店设备</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a class="btn btn-primary radius" onclick="hotelfac_add('添加酒店设备','${path}/HotelFac_add?hid=${hid }')" href="javascript:;">
			<i class="Hui-iconfont">&#xe600;</i> 添加酒店设备</a>
		</span>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			<c:forEach items="${HotelFacList }" var="list">
				<tr class="text-c va-m">
					...
					<td class="f-14 user-manage">
       					<a style="color: orange;" title="编辑" onclick="edit('编辑酒店设备','${path}/updateHotelFac?id=${list.id }')"  class="ml-5">编辑</a> 
	    				<a style="color: orange;" title="删除" onclick="del(this,'${path}/deleteHotelFac?id=${list.id  }')"  class="ml-5">删除</a>
       				</td>
       			</tr>
			</c:forEach>
			</tbody>
...
/*酒店设备-添加*/
function hotelfac_add(title,url){
