...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-roomtype-add"  class="form form-horizontal" enctype="multipart/form-data">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hid }" id="hid" name="hid" readonly="readonly" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入房间类型" id="htype" name="htype" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入可住人数" id="hnum" name="hnum" style="width: 90%">人
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入价格" id="hprice" name="hprice" style="width: 90%">元
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入房间类型" id="roomtotal" name="roomtotal" style="width: 90%">间房
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
						<button id="submitPic" lay-filter="Add" onClick="save();" class="btn btn-primary radius"  type="submit">
		...
		<script type="text/javascript">
			...
			function save(){
				var formData = new FormData($( "#hotel-roomtype-add" )[0]); //此处id为form表单的id
	       		$.ajax({  
		            url: "${path}/savaHotelRoomType" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
