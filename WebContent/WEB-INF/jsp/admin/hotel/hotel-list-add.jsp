...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="hotel-add">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店名称" id="hname" name="hname">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店电话" id="phone" name="phone">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">最低价格：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="lowprice" id="lowprice" placeholder="请输入最低价格" value="" class="input-text" style="width: 90%"> 元
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<script id="hotelintro" name="hotelintro" type="text/plain" style="width:100%;height:400px;"></script>
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#hotel-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/saveHotel" ,  
		            type: 'POST',  
		            data: formData,  
