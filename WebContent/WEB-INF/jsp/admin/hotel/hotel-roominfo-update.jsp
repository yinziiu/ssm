...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-roominfo-update" action="" method="post" class="form form-horizontal" >
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>房间设备id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelRoomInfo.id }" id="id" name="id">
					</div>
				</div>
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelRoomInfo.hid }" id="hid" name="hid">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>房间设备名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelRoomInfo.name }" placeholder="请输入房间设备名称" id="name" name="name">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			function save(){
	       		var formData = new FormData($("#hotel-roominfo-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update_HotelRoomInfo" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
