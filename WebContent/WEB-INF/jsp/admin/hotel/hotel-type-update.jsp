...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-type-update" action="" method="post" class="form form-horizontal" >
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelType2.id }" id="id" name="id">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店类型名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelType2.hoteltype }" placeholder="请输入酒店类型" id="hoteltype" name="hoteltype">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			function save(){
	       		var formData = new FormData($("#hotel-type-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update_HotelType" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
