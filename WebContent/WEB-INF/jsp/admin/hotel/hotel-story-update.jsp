...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="hotelstory-update">
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelStory.id }"  id="id" name="id">
					</div>
				</div>
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelStory.hid }"  id="hid" name="hid">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">酒店攻略：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<script id="gushi" name="gushi" type="text/plain" style="width:100%;height:400px;">${hotelStory.gushi}</script>
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			$(function() {
				var ue = UE.getEditor('gushi');
			});
			
			function save(){
	       		var formData = new FormData($("#hotelstory-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update_HotelStory" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
