...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-service-add" action="" method="post" class="form form-horizontal">
				<div class="row cl" style="display: none">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input name="hid" id="hid" type="text" value="${hid }" />
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入酒店服务名称" id="name" name="name">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#hotel-service-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/savaHotelService" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
