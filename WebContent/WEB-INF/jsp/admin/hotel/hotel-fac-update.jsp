...
<html>
	...
	<body>
		<div class="page-container">
			<form id="hotel-fac-update" action="" method="post" class="form form-horizontal" >
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>酒店设备id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelFac.id }" id="id" name="id">
					</div>
				</div>
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelFac.hid }" id="hid" name="hid">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${hotelFac.name }" placeholder="请输入酒店设备名称" id="name" name="name">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			function save(){
	       		var formData = new FormData($("#hotel-fac-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update_HotelFac" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
