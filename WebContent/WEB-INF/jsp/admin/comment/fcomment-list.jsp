...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>点评管理 <span class="c-gray en">&gt;</span> 餐饮点评列表
...
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" name="" id="" placeholder=" 餐饮名称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i>搜点评</button>
	</div>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
					...
					<th width="60">用户</th>
					<th width="40">头像</th>
					<th width="100">餐饮名称</th>
					<th>点评内容</th>
					<th width="100">点评时间</th>
					<th width="100">点评图片</th>
					<th width="100">操作</th>
				</tr>
			</thead>
			<tbody>
			<c:forEach items="${foodcommentList }" var="list">
				<tr class="text-c va-m">
					...
					<td class="text-l">${list.fcomment }</td>
					<td class="text-l">${list.fcommenttime }</td>
					<td class="text-l">
						<c:choose>
							...
							<c:otherwise>
								<img width="100px" height="100px" src="${path }${list.fphoto }" />
							</c:otherwise>
						</c:choose>
					</td>
					<td class="f-14 user-manage">
       					<a style="color: orange;" title="删除" onclick="fcomment_del(this,'${path}/deleteFComment?id=${list.id }')"  class="ml-5">删除</a>
       				</td>
       			</tr>
			</c:forEach>
			</tbody>
