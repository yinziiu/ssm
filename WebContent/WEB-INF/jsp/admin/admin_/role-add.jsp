	...
	<form action="" method="post" class="form form-horizontal" id="role-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-5">
				<input type="text" class="input-text" value="" placeholder="请输入角色名" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-4 col-sm-5 col-xs-offset-4 col-sm-offset-2">
...
function save(){
	var formData = new FormData($("#role-add")[0]);//此处id为form表单的id
    $.ajax({  
        url: "${path}/savarole" ,  
        type: 'POST',  
        data: formData,  
