...
<html>
	...
	<body>
		<div class="Huiform">
			...
			<form class="form form-horizontal" method="post" id="admin-update" enctype="multipart/form-data">
				<div class="row cl" style="display: none">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>id：</label>
					<div class="formControls col-xs-4 col-sm-5">
						<input type="text" class="input-text" value="${user.id }" placeholder="" id="id" name="id">
				...
				<div class="row cl" style="display: none">
					...
					<div class="formControls col-xs-4 col-sm-5">
						<input type="text" id="rid" name="rid" value="${user.rid }" class="input-text" readonly="readonly">
					</div>
				</div>
				<div class="row cl" >
					<label class="form-label col-xs-4 col-sm-3">角色：</label>
					<div class="formControls col-xs-4 col-sm-5">
						<input type="text" id="name" name="name" value="${user.name }" class="input-text" readonly="readonly">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#admin-update")[0]);//此处id为form表单的id
	       		$.ajax({  
		            url: "${path}/update_Admin" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
