...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="food-add" enctype="multipart/form-data">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>美食名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入美食名称" id="fname" name="fname">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<textarea style="height: 200px" name="fcontent" id="fcontent" cols="" rows="" class="textarea"  placeholder="请输入美食简介" ></textarea>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">人均消费：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入人均消费" id="expense" name="expense" style="width: 90%">人民币
					</div>
				</div>
				<div class="row cl">
			...
			<form action="" method="post" class="form form-horizontal" id="food-photo-add" enctype="multipart/form-data">
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#food-add")[0]);//此处id为form表单的id
		        $.ajax({  
