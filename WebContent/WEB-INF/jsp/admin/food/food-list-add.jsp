...
<html>
	...
	<body>
		<div class="page-container">
			<form  method="post" class="form form-horizontal" id="food-add" enctype="multipart/form-data">
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入人均消费" id="expense" name="expense">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">美食图：</label>
					<div class="formControls col-xs-8 col-sm-9">
