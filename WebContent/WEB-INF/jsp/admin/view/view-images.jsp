...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 景点列表 <span class="c-gray en">&gt;</span> 景点图片展示 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l"> 
			<a href="javascript:;" onclick="viewimg_add('添加图片','${path}/add_img?vid=${vid  }')" class="btn btn-primary radius">
		...
		<span class="r">共有图片：<strong></strong> 张</span>
	</div>
	<div class="portfolio-content">
		<ul class="cl portfolio-area">
			<c:forEach items="${viewImages }" var="list">
				<li class="item">
					<div class="portfoliobox">
						<input class="checkbox" name="" type="checkbox" value="">
						<div class="picbox">
							<a href="temp/big/keting.jpg" data-lightbox="gallery" >
								<img src="${path }${list.viewimg}">
							</a>
						</div>
					</div>
				</li>
...
/*景点-添加*/
function viewimg_add(title,url){
