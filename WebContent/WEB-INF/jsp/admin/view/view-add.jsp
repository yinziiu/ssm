...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="view-add" enctype="multipart/form-data">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>景点名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入景点名称" id="vname" name="vname">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入地址" id="location" name="location">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">参考用时：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入参考用时" id="usertime" name="usertime">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">门票：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea style="height: 150px" name="ticket" id="ticket" cols="" rows="" class="textarea"  placeholder="请输入门票提示"></textarea>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">交通：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea style="height: 150px" name="traffic" id="traffic" cols="" rows="" class="textarea"  placeholder="交通方式" ></textarea>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">提示：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="有提示吗" id="tips" name="tips">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">开放时间：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="开发时间" id="opentime" name="opentime">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<script id="intro" name="intro" type="text/plain" style="width:100%;height:400px;"></script>
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#view-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/saveView" ,  
		            type: 'POST',  
		            data: formData,  
