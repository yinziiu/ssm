...
<html>
	...
	<body>
		<div class="page-container">
			<c:if test="${!empty views.viewphoto }">
				<form class="form form-horizontal" method="post" id="update-photo" enctype="multipart/form-data">
					<div class="row cl" style="display: none">
						<label class="form-label col-xs-4 col-sm-2"><span
						class="c-red">*</span>景点id：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${views.id}" placeholder="请输入景点名称" id="id" name="id">
						</div>
					</div>
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2">景点图片：</label>
						<div class="formControls col-xs-8 col-sm-9">
	            			<img src="${path }${views.viewphoto}" width="90" height="90" >
						</div>
					</div>
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							...
							<input type="file" name="vphoto" id="vphoto" />
						</div>
					</div>
					<div class="row cl">
			...
			<c:if test="${empty views.viewphoto }">
				<form class="form form-horizontal" method="post" id="update-photo" enctype="multipart/form-data">
					<div class="row cl" style="display: none">
						<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>景点id：</label>
						<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.id}" placeholder="请输入景点名称" id="id" name="id">
						</div>
					</div>
			...
			<form action="" method="post" class="form form-horizontal" id="view-update" enctype="multipart/form-data">
				<div class="row cl" style="display: none">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>景点id：</label>
					<div class="formControls col-xs-8 col-sm-9">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.vname}" placeholder="请输入景点名称" id="vname" name="vname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">景点类型：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<span class="select-box"> 
							<select name="vtid" class="select">
								<c:forEach items="${viewTypes }" var="t">
									<option value="${t.id }">${t.viewtype }</option>
								</c:forEach>
							</select>
						</span>
					</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.location}" placeholder="请输入地址" id="location" name="location">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">参考用时：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.usertime}" placeholder="请输入参考用时" id="usertime" name="usertime">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">门票：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea style="height: 150px" name="ticket" id="ticket" cols="" rows="" class="textarea"  placeholder="请输入门票提示">${views.ticket}</textarea>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">交通：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea style="height: 150px" name="traffic" id="traffic" cols="" rows="" class="textarea"  placeholder="交通方式" >${views.traffic}</textarea>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">提示：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.tips}" placeholder="有提示吗" id="tips" name="tips">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">开放时间：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${views.opentime}" placeholder="开发时间" id="opentime" name="opentime">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">景点描述：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<script id="intro" name="intro" type="text/plain" style="width:100%;height:400px;">${views.intro}</script>
					</div>
				</div>
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
		...
		<script type="text/javascript">
			...
			$("#vphoto").change(function () {
		        $("#text").html($("#vphoto").val());
			});
			...
			function save(){
	       		var formData = new FormData($("#view-update")[0]);//此处id为form表单的id
		        $.ajax({  
