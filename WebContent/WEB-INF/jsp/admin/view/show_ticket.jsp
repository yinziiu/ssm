			...
			<form action="" method="post" class="form form-horizontal" id="form-article-add">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<textarea name="ticket" id="ticket" cols="" rows="" class="textarea"  placeholder="请输入门票提示" datatype="*10-100" dragonfly="true"  onKeyUp="$.Huitextarealength(this,1000)">${ticket }</textarea>
