...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="view-ticket-update">
				<div class="row cl" style="display: none;">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>门票id：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${viewTicket.id }"  id="id" name="id" readonly="readonly" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${viewTicket.vid }"  id="vid" name="vid" readonly="readonly" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>门票名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${viewTicket.tname }" placeholder="请输入门票名称" id="tname" name="tname" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">门票类型：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${viewTicket.ttype }" placeholder="成人票，双人票，学生票，亲子票，家庭票" id="ttype" name="ttype" style="width: 90%">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">价格：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="${viewTicket.tprice }" placeholder="请输入价格" id="tprice" name="tprice" style="width: 90%">元
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#view-ticket-update")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/update-view-ticket" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
