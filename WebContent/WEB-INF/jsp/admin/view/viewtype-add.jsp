...
<html>
	...
	<body>
		<div class="page-container">
			<form id="view-type-add" action="" method="post" class="form form-horizontal">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>景点类型名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入景点类型" id="viewtype" name="viewtype">
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#view-type-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/savaViewType" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
