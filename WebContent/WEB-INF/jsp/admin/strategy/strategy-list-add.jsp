...
<html>
	...
	<body>
		<div class="page-container">
			<form action="" method="post" class="form form-horizontal" id="strategy-add" enctype="multipart/form-data">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>攻略名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="请输入攻略名称" id="stname" name="stname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">攻略来自：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="来自" id="comefrom" name="comefrom">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<script id="stcontent" name="stcontent" type="text/plain" style="width:100%;height:400px;"></script>
					</div>
				</div>
				<div class="row cl">
		...
		<script type="text/javascript">
			...
			function save(){
	       		var formData = new FormData($("#strategy-add")[0]);//此处id为form表单的id
		        $.ajax({  
		            url: "${path}/saveStrategy" ,  
		            type: 'POST',  
		            data: formData,  
		            async: false,  
		            cache: false,  
