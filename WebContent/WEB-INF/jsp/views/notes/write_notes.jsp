...
<html>
	...
	<body>
		...
		<form action="${path }/web/savenotes" method="post" enctype="multipart/form-data">
			...
			<div id="topic"  class="pagelet-block" >
				<div class="set_index" id="_j_cover_box" style="height: 300px;">
					<div class="set_title ">
						<input type="text" id="notesname" name="notesname" value="" placeholder="填写游记名称" maxlength="48">
					</div>
				</div>
			</div>
				...
				<div class="content pagelet-block" style="background-color: " >
					...
					<div class="_j_content_box">
						<div class="textarea_placeholder _j_plc_item _j_inited with_placeholder_word">
							<textarea id="notescomment" name="notescomment" cols="30" rows="15" class="textarea _j_textarea _j_textareaplc" data-exclude_class="_j_textarea _j_textareaplc" placeholder="从这里开始游记正文..."></textarea>
						</div>
					</div>
				</div>
